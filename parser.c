...
void parse_file ( char * filename,
  ...
  while ( fgets(line, sizeof(line), f) != NULL ) {
    ...
    if ( strncmp(line, "box", strlen(line)) == 0 ) {
      ...
      struct matrix * shape = new_matrix(4,4);
      add_box(shape, xvals[0], yvals[0], zvals[0],
              xvals[1], yvals[1], zvals[1]);
      matrix_mult(peek(stack),shape);
      draw_polygons(shape,s,c);
      display( s );
      ...
      sscanf(line, "%lf %lf %lf %lf",
             xvals, yvals, zvals, &r);
      struct matrix * shape = new_matrix(4,4);
      add_sphere( shape, xvals[0], yvals[0], zvals[0], r, step_3d);
      matrix_mult(peek(stack),shape);
      draw_polygons(shape,s,c);
      display( s );
    }//end of sphere
      ...
      struct matrix * shape = new_matrix(4,4);
      add_torus(shape, xvals[0], yvals[0], zvals[0], r, r1, step_3d);
      matrix_mult(peek(stack),shape);
      draw_polygons(shape,s,c);
      display( s );
    }//end of torus
